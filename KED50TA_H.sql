DROP TABLE IF EXISTS KED50TA_H;

CREATE TABLE KED50TA_H (
    ...
    MAJ_GD5NM1      VARCHAR(100) NULL COMMENT '주요제품명',

    WTRBZ_CFMT_DV   CHAR(8)      NULL COMMENT '벤처기업확인서발급일',
    WTR_STRT_VLD_YMD CHAR(8)     NULL COMMENT '벤처기업확인시작일',
    WTR_END_VLD_YMD CHAR(8)      NULL COMMENT '벤처기업확인유효기간만료일',

    UPT_MTT         VARCHAR(500) NULL COMMENT '변경사항',
    KODATAUPD_DT    CHAR(8)      NULL COMMENT 'KoDATA 작업일자',
    ...
    LOT_INFO        VARCHAR(2)   NULL COMMENT '국세청 휴폐업 조회 정보(코드:3)',

    KODATACD        VARCHAR(10)  NOT NULL COMMENT 'KoDATA 기업식별ID(KED코드)',
    KODATAENP_NM    VARCHAR(100) NULL COMMENT 'KoDATA DBA 기업명',
